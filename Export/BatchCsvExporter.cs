...
namespace Correct_test1.Export
{
    ...
    {
        public string Export(List<CheckResult> results, string folder)
        {
            string fileName = "批量检查结果_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".csv";
            ...
            foreach (CheckResult result in results)
            {
                ...
                string link = "=HYPERLINK(\"" + result.FilePath + "\",\"打开图纸\")";
